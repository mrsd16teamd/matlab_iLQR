...
load('sys_id/experiments/round4/ramp4_Left_2.mat');
...
for i = 1:length(all_comb)
    param = all_comb(:,i);
    [sim_x_1L, sim_u] = inc_steer_sim(2,1,5,param);
    [sim_x_2L, sim_u] = inc_steer_sim(3,1,2,param);
    [sim_x_3L, sim_u] = inc_steer_sim(4,1,2,param);
    [sim_x_1R, sim_u] = inc_steer_sim(2,-1,5,param);
    [sim_x_2R, sim_u] = inc_steer_sim(3,-1,2,param);
    [sim_x_3R, sim_u] = inc_steer_sim(4,-1,2,param);
